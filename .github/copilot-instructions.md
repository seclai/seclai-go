...
- `resolveSsoToken` distinguishes nil cache ("No cached SSO token found") vs expired ("SSO token expired").
- Auth modes: `api_key`, bearer (static string / provider function), `sso` with auto-refresh.
